                                                ...
                                                onPressed: () async {
                                                  ...
                                                  if ((_model.predictionResult
                                                    ...
                                                    await actions
                                                      ...
                                                      _model.uploadedLocalFile,
                                                      _model.predictionId!.id,
                                                    );
                                                    _model.outputleft =
                                                        await actions.testLeft(
                                                      context,
                                                    ...
                                                    _model.openAIOutput =
                                                      ...
                                                      dailyCalories:
                                                          FFAppState()
                                                              .CalorieCalc,
                                                      dailyCarbs: FFAppState()
                                                          .CarbsCalc,
                                                      dailyFat:
                                                          FFAppState().FatCalc,
                                                      dailyProtein: FFAppState()
                                                          .ProtienCalc,
                                                      leftCalories: FFAppState()
                                                          .CaloriesLeft,
                                                      leftCarbs: FFAppState()
                                                          .CarbsLeft,
                                                      leftFat:
                                                          FFAppState().FatLeft,
                                                      leftProtein: FFAppState()
                                                          .ProtienLeft,
                                                      mealCalories:
                                                          getJsonField(
                                                        (_model.predictionResult
