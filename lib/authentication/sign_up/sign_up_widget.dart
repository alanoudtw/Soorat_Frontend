                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'njr2vsic' /* Let’s sign up to your account ... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                        ...
                                        children: [
                                          TextSpan(
                                            text: FFLocalizations.of(context)
                                                .getText(
                                              'fspov3z3' /* Already have an account?  */,
                                            ),
                                            style: TextStyle(),
                                          ),
                                          TextSpan(
