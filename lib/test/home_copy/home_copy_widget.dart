...
class _HomeCopyWidgetState extends State<HomeCopyWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      future: UploadImageAndGetNutritionCall.call(),
      builder: (context, snapshot) {
        ...
        final homeCopyUploadImageAndGetNutritionResponse = snapshot.data!;
                                    ...
                                    children: [
                                      ...
                                      Align(
                                        ...
                                        child: CircularPercentIndicator(
                                          ...
                                          progressColor: Color(0xFF3DB549),
                                          backgroundColor: Color(0x4B9D9D9D),
                                          center: Text(
                                            FFLocalizations.of(context).getText(
                                              '080f0grw' /* 
732.8 cals
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          LinearPercentIndicator(
                                            ...
                                            animateFromLastPercent: true,
                                            progressColor: Color(0xFF3DB549),
                                            backgroundColor: Color(0x379D9D9D),
                                                  ...
                                                  children: [
                                                    Align(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: Image.network(
                                                          'https://images.unsplash.com/photo-1505576633757-0ac1084af824?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwyM3x8cGxhdGV8ZW58MHx8fHwxNzQwMzIyNjY5fDA&ixlib=rb-4.0.3&q=80&w=1080',
                                                          fit: BoxFit.cover,
                                                        ),
                                                      ),
                                                    ),
